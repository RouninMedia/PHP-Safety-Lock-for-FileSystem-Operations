...
The **PHP Safety Lock** ensures that whenever a page including a FileSystem Operations PHP script loads or reloads, no files within the filesystem can be *accidentally* overwritten or deleted.
